...
export interface Model {
  ...
  ancestor?: string; // id of the previous model in this series (for trajectory lines)
  scores: Scores;
...
export const models: Model[] = [
  ...
  // --- Cohere ---
  {
    ...
    supportsImages: false,
    openWeights: true,
    ancestor: "command-r-plus-04-2024",
